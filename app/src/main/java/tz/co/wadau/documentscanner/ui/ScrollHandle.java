    ...
    public void setupLayout(PDFView pdfView) {
        ...
        if (pdfView.isSwipeVertical()) {
            ...
            if (inverted) { // left
                ...
                background = ContextCompat.getDrawable(context, R.drawable.ic_scroll_handle_right);
            }
        } else {
            width = HANDLE_SHORT;
            height = HANDLE_LONG;
        ...
        RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(Util.getDP(context, width), Util.getDP(context, height));
