...
public class ShareAsPictureAdapter extends RecyclerView.Adapter<ShareAsPictureAdapter.OrganizePagesViewHolder> {

    private final String TAG = ShareAsPictureAdapter.class.getSimpleName();
    ...
    public ShareAsPictureAdapter(Context context, List<PDFPage> pdfPages) {
...
//            holder.pdfWrapper.setBackground(null);
    ...
    public void swapPages(int from, int to){
        PDFPage dPage = pdfPages.remove(to);
        pdfPages.add(from, dPage);
    }
