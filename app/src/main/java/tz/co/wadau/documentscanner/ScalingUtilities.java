...
public class ScalingUtilities {
	/**
	 * ScalingLogic defines how scaling should be carried out if source and destination image has different aspect ratio.
	 * 
	 * CROP: Scales the image the minimum amount while making sure that at least one of the two dimensions fit inside the requested destination area. Parts of the source image will
	 * be cropped to realize this.
	 * 
